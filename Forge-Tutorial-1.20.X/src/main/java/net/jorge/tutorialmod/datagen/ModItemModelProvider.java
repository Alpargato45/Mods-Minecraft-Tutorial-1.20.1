...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        simpleItem(ModItems.ZAFIRO_CRUDO);
        simpleItem(ModItems.STRAWBERRY);

        simpleBlockItem(ModBlock.PUERTA_DE_ZAFIRO);

        fenceItem(ModBlock.VALLA_DE_ZAFIRO, ModBlock.BLOQUE_ZAFIRO);
        buttonItem(ModBlock.BOTON_DE_ZAFIRO, ModBlock.BLOQUE_ZAFIRO);
        wallItem(ModBlock.MURO_DE_ZAFIRO, ModBlock.BLOQUE_ZAFIRO);

        evenSimplerBlockItem(ModBlock.ESCALERAS_DE_ZAFIRO);
        evenSimplerBlockItem(ModBlock.SLAB_DE_ZAFIRO);
        evenSimplerBlockItem(ModBlock.PLACA_DE_PRESION_DE_ZAFIRO);
        evenSimplerBlockItem(ModBlock.VALLA_PUERTA_DE_ZAFIRO);

        trapdoorItem(ModBlock.TRAMPILLA_DE_ZAFIRO);
